...
import com.android_development.tool.ShellUtils;
import com.android_development.tool.ShellUtils.CommandResult;
...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath) {
    	DebugUtils.printInfo(TAG, "installSilent=" + filePath);
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        DebugUtils.printInfo(TAG, new StringBuilder().append("installSilent successMsg:").append(commandResult.successMsg)
    ...
    public static int uninstallSilent(Context context, String packageName, boolean isKeepData) {
         ...
         **/
        //StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=/vendor/lib:/system/lib pm uninstall --user 0 ")
